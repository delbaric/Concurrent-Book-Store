...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class, Callback> MessageTypeMap;
    /**
    ...
    public MicroService(String name) {
        ...
        MessageTypeMap = new ConcurrentHashMap<>();
    }
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        MessageBus.subscribeEvent(type,this); // send this MicroService to the message bus in order to get subscribed to the event type
        MessageTypeMap.put(type, callback);
    }
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        MessageBus.subscribeBroadcast(type,this); // send this MicroService to the message bus in order to get subscribed to the broadcast type
        MessageTypeMap.put(type, callback);
    }
    ...
    public final void run() {
        ...
        while (!(terminated)) {
            ...
            this.MessageTypeMap.get(currMessage.getClass()).call(currMessage);
        }
